...
public class PersonalJournalEntryEdit extends MenuActivity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_personal_journal_entry_edit);
        ...
        editTxtJournalTitle.setText(title);
        editTxtJournalDescription.setText(description);
